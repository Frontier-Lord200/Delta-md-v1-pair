...
router.get('/', async (req, res) => {
    ...
    async function DELTA-MD-V1_PAIR_CODE() {
        const {
            state,
            saveCreds
...
Thanks for using *MALVIN-XD* — you have sub linked with your DELTA-MD-V1 session!
...
{quoted:ddd })
   ...
   return await DELTA-MD-V1_PAIR_CODE();
});/*
setInterval(() => {
